...
'血型抗体特异性鉴定（吸收试验）' -- "RC"  "GZL"
   ...
   + (SELECT SUM(CASE WHEN T."kcjl" = '出库记录'AND T."xx1" = '合计' AND T."js1" = '袋'AND T."xx2" = '合计' AND T."js2" = '袋'AND T."xx3" = '合计' AND T."js3" = '袋'AND T."xx4" = '合计' AND T."js4" = '袋'THEN T."hxb1" + T."xj1" + T."xxb1" + T."lcd1"ELSE 0 END) + SUM(CASE WHEN T."kcjl" = '入库记录'AND T."xx1" = '合计' AND T."js1" = '袋'AND T."xx2" = '合计' AND T."js2" = '袋'AND T."xx3" = '合计' AND T."js3" = '袋'AND T."xx4" = '合计' AND T."js4" = '袋'THEN T."hxb1" + T."xj1" + T."xxb1" + T."lcd1"ELSE 0 END) + SUM(CASE WHEN T."kcjl" = '出库记录'AND T."xx1" = '合计' AND T."js1" = '袋'AND T."xx2" = '合计' AND T."js2" = '袋'AND T."xx3" = '合计' AND T."js3" = '袋'AND T."xx4" = '合计' AND T."js4" = '袋'THEN T."hxb1" + T."xxb1"ELSE 0 END) + SUM(CASE WHEN T."kcjl" = '出库记录'AND T."xx1" = '合计' AND T."js1" = '袋'AND T."xx2" = '合计' AND T."js2" = '袋'AND T."xx3" = '合计' AND T."js3" = '袋'AND T."xx4" = '合计' AND T."js4" = '袋'THEN T."xxb1" * 3 ELSE 0 END) as "血库计算" FROM (SELECT '库存记录' as "kcjl", 'O型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "hxb1", 'O型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "xj1", 'O型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "xxb1", 'O型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "lcd1", '001' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'O型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'O型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'O型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'O型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '002' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'A型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "hxb1", 'A型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "xj1", 'A型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "xxb1", 'A型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "lcd1", '003' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'A型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'A型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'A型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'A型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '004' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'B型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "hxb1", 'B型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "xj1", 'B型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "xxb1", 'B型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "lcd1", '005' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'B型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'B型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'B型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'B型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '006' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'AB型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "hxb1", 'AB型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "xj1", 'AB型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "xxb1", 'AB型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "lcd1", '007' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'AB型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'AB型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'AB型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'AB型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '008' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", '合计' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' THEN a."bloodbag_id" END) as "hxb1", '合计' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' THEN a."bloodbag_id" END) as "xj1", '合计' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' THEN a."bloodbag_id" END) as "xxb1", '合计' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' THEN a."bloodbag_id" END) as "lcd1", '009' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", '合计' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", '合计' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", '合计' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", '合计' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '010' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '入库记录' as "kcjl", 'O型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "hxb1", 'O型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "xj1", 'O型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "xxb1", 'O型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "lcd1", '011' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'O型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'O型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'O型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'O型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '012' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'A型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "hxb1", 'A型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "xj1", 'A型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "xxb1", 'A型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "lcd1", '013' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'A型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'A型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'A型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'A型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '014' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'B型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "hxb1", 'B型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "xj1", 'B型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "xxb1", 'B型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "lcd1", '015' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'B型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'B型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'B型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'B型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '016' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'AB型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "hxb1", 'AB型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "xj1", 'AB型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "xxb1", 'AB型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "lcd1", '017' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'AB型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'AB型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'AB型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'AB型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '018' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", '合计' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' THEN a."bloodbag_id" END) as "hxb1", '合计' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' THEN a."bloodbag_id" END) as "xj1", '合计' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' THEN a."bloodbag_id" END) as "xxb1", '合计' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' THEN a."bloodbag_id" END) as "lcd1", '019' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", '合计' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", '合计' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", '合计' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", '合计' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '020' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'O型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "hxb1", 'O型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "xj1", 'O型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "xxb1", 'O型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "lcd1", '021' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'O型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'O型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'O型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'O型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '022' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'A型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "hxb1", 'A型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "xj1", 'A型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "xxb1", 'A型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "lcd1", '023' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'A型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'A型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'A型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'A型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '024' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'B型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "hxb1", 'B型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "xj1", 'B型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "xxb1", 'B型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "lcd1", '025' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'B型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'B型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'B型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'B型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '026' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'AB型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "hxb1", 'AB型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "xj1", 'AB型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "xxb1", 'AB型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "lcd1", '027' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'AB型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'AB型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'AB型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'AB型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '028' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", '合计' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' THEN a."bloodbag_id" END) as "hxb1", '合计' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' THEN a."bloodbag_id" END) as "xj1", '合计' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' THEN a."bloodbag_id" END) as "xxb1", '合计' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' THEN a."bloodbag_id" END) as "lcd1", '029' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", '合计' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", '合计' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", '合计' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", '合计' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '030' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d') ) T )
   + (
SELECT 
count(1)
...
WHERE Order_Main_RecDeptName in ( '输血科','锦江输血科' )
    ...
    AND Order_Main_OrderDtTm <= date_format(date_add('day', -1, date_trunc('month', current_date)), '%Y-%m-%d')  -- 结束时间
      ...
      + (select sum(cast(finished_amount as double ))  from hid0117_orcl_lis_xhbis.bis6_blood_inventory  where  inventory_time between date_format(date_trunc('month', date_add('month', -1, current_date)), '%Y-%m-%d') and date_format(date_add('day', -1, date_trunc('month', current_date)), '%Y-%m-%d'))
...
FROM (
    ...
    FROM hid0117_orcl_lis_dbo.lis_inspection_sample a
    INNER JOIN hid0117_orcl_lis_dbo.lis_inspection_sample_charge b
        ON a."inspection_id" = b."inspection_id"
        AND b."isdeleted" = '0'
    INNER JOIN hid0117_orcl_lis_xhsystem1.lis_charge_item c
    ...
    FROM hid0117_orcl_lis_xhdata.lis6_inspect_sample a
    INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT b
        ON a."inspection_id" = b."INSPECTION_ID"
        AND b."isdeleted" = '0'
    INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type c
        ON b."BLOOD_TYPE_ID" = c."BLOOD_TYPE_ID"
        AND c."isdeleted" = '0'
    INNER JOIN hid0117_orcl_lis_xhbis.bis6_charged_info d
        ON b."BLOODBAG_ID" = d."sample_charge_id"
        AND d."isdeleted" = '0'
    INNER JOIN hid0117_orcl_lis_xhinterface.xinghe_charged_list e
    ...
    INNER JOIN hid0117_orcl_lis_xhinterface.xinghe_charged_list b
    ...
    FROM hid0117_orcl_lis_bis.his_requisition a
    INNER JOIN hid0117_orcl_lis_xhbis.bis6_req_info b
...
WHERE Order_Main_RecDeptName in ('输血科','锦江输血科')
    ...
    AND Order_Main_OrderDtTm <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d')  -- 结束时间
      and medorgcode = 'HID0101')
      + (select sum(cast(finished_amount as double ))  from hid0117_orcl_lis_xhbis.bis6_blood_inventory  where  inventory_time between date_format(date_trunc('month', date_add('month', -2, current_date)), '%Y-%m-%d') and date_format(date_add('day', -1, date_trunc('month', date_add('month', -1, current_date))), '%Y-%m-%d'))
...
'血型抗体特异性鉴定（吸收试验）' -- "RC"  "GZL"
    ...
    + SUM(CASE WHEN "XM" = '血型抗体效价测定（IgG+IgM）' THEN "GZL" ELSE 0 END) * 3 
   + (SELECT SUM(CASE WHEN T."kcjl" = '出库记录'AND T."xx1" = '合计' AND T."js1" = '袋'AND T."xx2" = '合计' AND T."js2" = '袋'AND T."xx3" = '合计' AND T."js3" = '袋'AND T."xx4" = '合计' AND T."js4" = '袋'THEN T."hxb1" + T."xj1" + T."xxb1" + T."lcd1"ELSE 0 END) + SUM(CASE WHEN T."kcjl" = '入库记录'AND T."xx1" = '合计' AND T."js1" = '袋'AND T."xx2" = '合计' AND T."js2" = '袋'AND T."xx3" = '合计' AND T."js3" = '袋'AND T."xx4" = '合计' AND T."js4" = '袋'THEN T."hxb1" + T."xj1" + T."xxb1" + T."lcd1"ELSE 0 END) + SUM(CASE WHEN T."kcjl" = '出库记录'AND T."xx1" = '合计' AND T."js1" = '袋'AND T."xx2" = '合计' AND T."js2" = '袋'AND T."xx3" = '合计' AND T."js3" = '袋'AND T."xx4" = '合计' AND T."js4" = '袋'THEN T."hxb1" + T."xxb1"ELSE 0 END) + SUM(CASE WHEN T."kcjl" = '出库记录'AND T."xx1" = '合计' AND T."js1" = '袋'AND T."xx2" = '合计' AND T."js2" = '袋'AND T."xx3" = '合计' AND T."js3" = '袋'AND T."xx4" = '合计' AND T."js4" = '袋'THEN T."xxb1" * 3 ELSE 0 END) as "血库计算" FROM (SELECT '库存记录' as "kcjl", 'O型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "hxb1", 'O型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "xj1", 'O型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "xxb1", 'O型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "lcd1", '001' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'O型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'O型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'O型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'O型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '002' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'A型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "hxb1", 'A型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "xj1", 'A型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "xxb1", 'A型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "lcd1", '003' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'A型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'A型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'A型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'A型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '004' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'B型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "hxb1", 'B型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "xj1", 'B型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "xxb1", 'B型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "lcd1", '005' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'B型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'B型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'B型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'B型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '006' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'AB型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "hxb1", 'AB型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "xj1", 'AB型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "xxb1", 'AB型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "lcd1", '007' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", 'AB型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'AB型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'AB型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'AB型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '008' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", '合计' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' THEN a."bloodbag_id" END) as "hxb1", '合计' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' THEN a."bloodbag_id" END) as "xj1", '合计' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' THEN a."bloodbag_id" END) as "xxb1", '合计' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' THEN a."bloodbag_id" END) as "lcd1", '009' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '库存记录' as "kcjl", '合计' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", '合计' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", '合计' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", '合计' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '010' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."bloodbag_state" IN ('1','2') AND a."isdeleted" = '0'UNION ALL SELECT '入库记录' as "kcjl", 'O型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "hxb1", 'O型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "xj1", 'O型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "xxb1", 'O型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "lcd1", '011' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'O型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'O型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'O型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'O型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '012' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'A型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "hxb1", 'A型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "xj1", 'A型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "xxb1", 'A型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "lcd1", '013' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'A型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'A型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'A型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'A型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '014' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'B型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "hxb1", 'B型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "xj1", 'B型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "xxb1", 'B型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "lcd1", '015' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'B型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'B型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'B型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'B型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '016' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'AB型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "hxb1", 'AB型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "xj1", 'AB型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "xxb1", 'AB型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "lcd1", '017' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", 'AB型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'AB型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'AB型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'AB型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '018' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", '合计' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' THEN a."bloodbag_id" END) as "hxb1", '合计' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' THEN a."bloodbag_id" END) as "xj1", '合计' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' THEN a."bloodbag_id" END) as "xxb1", '合计' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' THEN a."bloodbag_id" END) as "lcd1", '019' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '入库记录' as "kcjl", '合计' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", '合计' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", '合计' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", '合计' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '020' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."in_time" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."in_time" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'O型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "hxb1", 'O型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "xj1", 'O型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "xxb1", 'O型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='O型' THEN a."bloodbag_id" END) as "lcd1", '021' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'O型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'O型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'O型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'O型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='O型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '022' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'A型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "hxb1", 'A型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "xj1", 'A型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "xxb1", 'A型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='A型' THEN a."bloodbag_id" END) as "lcd1", '023' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'A型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'A型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'A型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'A型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='A型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '024' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'B型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "hxb1", 'B型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "xj1", 'B型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "xxb1", 'B型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='B型' THEN a."bloodbag_id" END) as "lcd1", '025' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'B型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'B型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'B型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'B型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='B型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '026' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'AB型' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "hxb1", 'AB型' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "xj1", 'AB型' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "xxb1", 'AB型' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='AB型' THEN a."bloodbag_id" END) as "lcd1", '027' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", 'AB型' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", 'AB型' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", 'AB型' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", 'AB型' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' AND a."abo_blood_group"='AB型' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '028' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", '合计' as "xx1", '袋' as "js1", COUNT(DISTINCT CASE WHEN c."component_id"='00000009' THEN a."bloodbag_id" END) as "hxb1", '合计' as "xx2", '袋' as "js2", COUNT(DISTINCT CASE WHEN c."component_id"='00000010' THEN a."bloodbag_id" END) as "xj1", '合计' as "xx3", '袋' as "js3", COUNT(DISTINCT CASE WHEN c."component_id"='00000011' THEN a."bloodbag_id" END) as "xxb1", '合计' as "xx4", '袋' as "js4", COUNT(DISTINCT CASE WHEN c."component_id"='00000012' THEN a."bloodbag_id" END) as "lcd1", '029' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') UNION ALL SELECT '出库记录' as "kcjl", '合计' as "xx1", '量' as "js1", SUM(CASE WHEN c."component_id"='00000009' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "hxb1", '合计' as "xx2", '量' as "js2", SUM(CASE WHEN c."component_id"='00000010' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xj1", '合计' as "xx3", '量' as "js3", SUM(CASE WHEN c."component_id"='00000011' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "xxb1", '合计' as "xx4", '量' as "js4", SUM(CASE WHEN c."component_id"='00000012' THEN CAST(a."blood_amount" AS DOUBLE) ELSE 0 END) as "lcd1", '030' as "sort"FROM hid0117_orcl_lis_xhbis.BIS6_BLOODBAG_INPUT a INNER JOIN hid0117_orcl_lis_xhbis.bis6_match_blood_type b ON a."blood_type_id" = b."blood_type_id"AND b."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhbis.BIS6_BLOOD_COMPONENT c ON b."component_id" = c."component_id"AND c."isdeleted" = '0'INNER JOIN hid0117_orcl_lis_xhdata.LIS6_INSPECT_SAMPLE d ON a."inspection_id" = d."inspection_id"AND d."isdeleted" = '0'WHERE a."isdeleted" = '0'AND a."out_date" >= date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') AND a."out_date" <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d') ) T )
   + (
SELECT 
count(1)
...
WHERE Order_Main_RecDeptName like '%输血%'
    ...
    AND Order_Main_OrderDtTm <= date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d')  -- 结束时间
      and medorgcode = 'HID0101')
      + (select sum(cast(finished_amount as double ))  from hid0117_orcl_lis_xhbis.bis6_blood_inventory  where  inventory_time between date_format(date_trunc('month', date_add('month', -13, current_date)), '%Y-%m-%d') and date_format(date_add('day', -1, date_trunc('month', date_add('month', -12, current_date))), '%Y-%m-%d'))

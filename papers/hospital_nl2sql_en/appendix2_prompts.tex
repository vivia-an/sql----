%==============================================================================
%  Supplementary File S2 — Prompt templates
...
\begin{center}
{\large\bfseries Supplementary File S2. Prompt templates}\\[2pt]
...
\begin{itemize}[leftmargin=1.4em,itemsep=1pt,topsep=2pt]
  ...
  \item Model builds: gpt-4o-2024-08-06, deepseek-v3-0324,
        claude-3-5-sonnet-20241022 (cloud, API); qwen2.5:7b-instruct, glm4:9b,
        llama3:8b-instruct, deepseek-r1:7b, phi3:mini (on-premises, vLLM).
  \item Random seeds are not applicable under deterministic decoding; the
        SynHDW generator seed is 20250301.
\end{itemize}

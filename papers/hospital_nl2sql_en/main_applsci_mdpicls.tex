...
% To print the ORCID iD beside the author name, give the iD here and append
% \orcidA{} to the \Author entry; mdpi.cls builds the link from this macro.
...
% Single author, single affiliation: mdpi.cls suppresses the starred
% correspondence line under the oneauthor option, so the contact address goes
% on the affiliation line, which is how MDPI sets single-author papers.
\address[1]{Department of Information and Data Management, West China Hospital,
Sichuan University, Chengdu 610041, China; \PH{author@example.edu};
Tel.: \PH{+86 ...}}
...
% Applied Sciences caps the abstract at 200 words; it is a desk check, so any
% edit here must be re-counted (the count is asserted in verify_structure.py).
\abstract{Hospital reporting depends on institution-specific statistical
...
\authorcontributions{S.L. is the sole author and carried out, in CRediT terms,
conceptualization, methodology, software, validation, formal analysis,
investigation, data curation, visualization, and writing---both original draft
preparation and review and editing. The author has read and agreed to the
...
\conflictsofinterest{A related invention by the author (patent AJ2534335, a
...
\emph{without} reinforcement learning. The author declares no other conflict of

...
%--- long DOI strings in the reference list are otherwise unbreakable
\makeatletter
\g@addto@macro\UrlBreaks{\do\a\do\b\do\c\do\d\do\e\do\f\do\g\do\h\do\i\do\j
  ...
  \do\z\do\A\do\B\do\C\do\D\do\E\do\F\do\G\do\H\do\I\do\J\do\K\do\L\do\M\do\N
  \do\O\do\P\do\Q\do\R\do\S\do\T\do\U\do\V\do\W\do\X\do\Y\do\Z\do\0\do\1\do\2
  \do\3\do\4\do\5\do\6\do\7\do\8\do\9}
\makeatother
...
\begin{tabular}{@{}L{2.35cm}L{1.42cm}L{1.42cm}L{1.5cm}L{1.42cm}L{1.8cm}L{1.42cm}@{}}
\toprule
Model & Architec\-ture & SQL\tnote{a} genera\-tion (\%) & Halluci\-nation (\%)\tnote{b}
      & Effec\-tive SQL (\%)\tnote{c} & Time (s)\tnote{d} & Cost (US \$)/Query\\
\midrule
...
\footnotesize
\setlength{\tabcolsep}{3pt}
\begin{tabular}{@{}L{2.4cm}L{1.55cm}L{1.65cm}L{1.65cm}L{1.65cm}L{1.55cm}L{1.55cm}@{}}
\toprule

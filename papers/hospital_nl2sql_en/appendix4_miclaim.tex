...
5.2 & Tier 2: code released, data available on request & \Y & \textbf{This study.} Pipeline and detector code at \PH{repository URL}; the synthetic warehouse generator and its schema manifest ship with the code; de-identified metadata schemas, the metric-criterion dictionary, and the task set are available under a data use agreement\\
...
%==============================================================================
\section{Part 2 --- MI-CLAIM-GEN (Miao et al, 2024)}
%==============================================================================

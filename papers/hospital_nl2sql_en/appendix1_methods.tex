%==============================================================================
%  Multimedia Appendix 1 — Supplementary methods
...
\begin{center}
{\large\bfseries Multimedia Appendix 1. Supplementary methods}\\[2pt]
...
\node[mod, right=of ie] (rec)
  {\textbf{Candidate recall}\\{\tiny hybrid BM25 + dense,\\top-$k$=8 per term}};
...
Weights used in all reported experiments: $\alpha=\PH{fill}$,
$\beta=\PH{fill}$, $\gamma=\PH{fill}$.
...
Other, n                         & 0   & 1   & 3\\
\addlinespace
Simple, n                        & \PH{fill} & 2 & 10\\
Moderate, n                      & \PH{fill} & 3 & 9\\
Complex, n                       & \PH{fill} & 2 & 5\\
\addlinespace
Business terms extracted, n      & 412 & 163 & \PH{fill}\\
...
($\sim$1900 of the $>$14{,}000 production columns), which is what makes it a test
...
Generation seed: \PH{fill}. Row counts: 128{,}470 synthetic patients,
\PH{fill} visits, \PH{fill} surgical records, \PH{fill} transfusion records,
\PH{fill} laboratory results, covering 2019--2023.
...
\begin{enumerate}[leftmargin=1.6em,itemsep=1pt,topsep=2pt]
  ...
  \item Detect placeholder literals by pattern (angle brackets, ellipses,
        ...
        listed in \PH{fill}). These are \textbf{Category D}.
...
\vspace{4pt}
\noindent
Detection was validated against manual adjudication on a random sample of
\PH{fill} queries; agreement was \PH{fill}.
